...
Nous ferons une plongée au sein des données d'Airbnb ; on exploirera : - la structure des biens, 
**Contenus**
...
<img src="https://raw.githubusercontent.com/JeremieDec/home/master/pics/Bordeaux%20Post/Typesdelogement.png" width="55%">
...
<img src="https://raw.githubusercontent.com/JeremieDec/home/master/pics/Bordeaux%20Post/missingnoNullmatrix.png" width="80%">
...
<img src="https://raw.githubusercontent.com/JeremieDec/home/master/pics/Bordeaux%20Post/plot_xgb_price_inf200.png" width="100%">
...
La méthode de la moyenne est un échec, cependant, observons le résultat sur l'objectif des prix de location inférieurs à 200 € : 
...
Voilà 3.5% d'amélioration par rapport à la baseline : 9.53 d'erreur médiane absolue contre 9.89 ! L'imputation par la moyenne a tendance à donner des estimations erronnées pour les prix élevés... Effectivement, les prix sont proches de la moyenne dans le 9ème décile (la moyenne est proche de plus de 90% des données).
...
```
Et voila, ce qui devait arriver s'est produit : Des variables imputées extremistes (k=1 plus proche voisin) se sont infiltrées à l'entraînement. On remarque cependant le prix médian de 9.86 comparable à la baseline (9.89) mais il n'y a pas eu de gain d'information (il y aurait toujours possiblité d'inspecter en détails s'il existe des variables dont l'erreur a été réduite)
...
<img src="https://raw.githubusercontent.com/JeremieDec/home/master/pics/Bordeaux%20Post/linScores.png" width="100%">
