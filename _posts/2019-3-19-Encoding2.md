...
Lesuper bon ?
<img src="https://raw.githubusercontent.com/JeremieDec/home/master/pics/hmapListesparquartier.png" width="70%">
 
 <img src="https://jeremiedec.github.io/home/blob/master/pics/hmapListesparquartier.png" width="80%"> 
<img src="./pics/hmapListesparquartier.png" width="30%">

bon cette fois
![fresh site](/pics/hmapListesparquartier.png)

When you type something on keyboard, or load a document, how does the computer figures out how to display it ? This is what character encoding is for.
I didn t understand a peanut about this subject before I wrote the article. Char encoding is the basis where our code is sitting on. As natively configurated (often), we don't have to care much about it, but when one day comes an issue about this topic, let's say 'SyntaxError: (unicode error) 'unicodeescape' codec can't decode bytes in position 2-4', It can be frustrating.
I made a summary of a bunch of articles and hope you it can sound clears to you.
It can sound annoying at first, but if you give 3 mins to grab the basics, it's good for life.
At the beginning, character encoding wasn't much regarded since PCs didn't communicate with one another.   
Thus, many character encodings convert to letters, numbers, accentuation marks, specifics symbols ect. 

With the raise of internet, it runs now as mandatory quasi-invisible task.  
...
<img src="https://JeremieDec.github.io/pics/CharsFontglyph.png" width="70%">

      

<img src="https://JeremieDec.github.io/pics/encodtable.PNG" width="120%">
...
<img src="https://JeremieDec.github.io/pics/notpadChars.png">
...
<img src="https://github.com/JeremieDec/JeremieDec.github.io/blob/master/pics/utf8.png">
...
<img src="https://JeremieDec.github.io/pics/hexa.PNG">
